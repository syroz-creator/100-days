...
const LABELS: Record<ReminderType, string> = {
  ...
  leaveForSchool: 'Leave for school',
  schoolFinished: 'School finishing',
  directGym: 'Go directly to gym',
  homework: 'Homework',
  subject14: 'Subject 14 development time',
  schoolPrep: 'Prepare bag and gym clothes',
  hairGrowthPhotos: 'Hair-growth photos',
